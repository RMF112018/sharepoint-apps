...
export default class NewProjectIntakeWebPart extends BaseClientSideWebPart<IDemoEmbedWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IDemoEmbedProps> = React.createElement(
      DemoEmbed,
      {
        ...
        targetListName: this.properties.targetListName || 'NewProjectIntake',
